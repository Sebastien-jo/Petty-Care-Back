 ...
 */
final class Version20220613094827 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE pet DROP FOREIGN KEY FK_E4529B859D86650F');
        $this->addSql('DROP INDEX IDX_E4529B859D86650F ON pet');
        $this->addSql('ALTER TABLE pet CHANGE user_id_id user_id INT NOT NULL');
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE pet CHANGE user_id user_id_id INT NOT NULL');
        $this->addSql('ALTER TABLE pet ADD CONSTRAINT FK_E4529B859D86650F FOREIGN KEY (user_id_id) REFERENCES user (id)');
        $this->addSql('CREATE INDEX IDX_E4529B859D86650F ON pet (user_id_id)');
    }
}
